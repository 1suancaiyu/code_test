...
# MEModule ShiftModule Bottle2neckShift Bottle2neck Res2Net
...
tea = Bottle2neckShift(inplanes=64, planes=128, stride=1, downsample=None, baseWidth=26, scale=4, stype='normal')
